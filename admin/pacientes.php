...
<!-- <div class="serviciosColor">
    <div class="colorContainer">
        <div class="color" style="background-color: #E2C6C2;"></div>
        <span>Kinesiología</span>
    </div>
    <div class="colorContainer">
        <div class="color" style="background-color: #A6DA9C;"></div>
        <span>Terapia manual</span>
    </div>
    <div class="colorContainer">
        <div class="color" style="background-color: #BBFFFF;"></div>
        <span>Drenaje linfático</span>
    </div>
    <div class="colorContainer">
        <div class="color" style="background-color: #EE976A;"></div>
        <span>Nutrición</span>
    </div>
    <div class="colorContainer">
        <div class="color" style="background-color: #A9B0F4;"></div>
                        ...
                        <td>
                            <?php if (isset($pacientes_por_dia[$i])): ?>
                                <?php foreach ($pacientes_por_dia[$i] as $paciente): ?>
                                    <?php
                                    $color = isset($colores_servicio[$paciente['servicio']]) ? $colores_servicio[$paciente['servicio']] : '#ffffff';
                                    ?>
                                    <div class="patient-card" style="background-color: <?php echo $color; ?>" onclick="location.href='diagnostico.php?id=<?php echo $paciente['id']; ?>'">
                                        <p><strong><?php echo $paciente['nombre']; ?></strong></p>
                                        <p><strong><?php echo $paciente['numero_sesion']; ?></strong></p>
                                    </div>
                                <?php endforeach; ?>
                            <?php else: ?>
