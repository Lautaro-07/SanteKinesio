...
<body>
    ...
    <section class="profesionales_container">
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=lucia'">
        ...
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=alejandro'">
                <div class="imgProfesional">
                    <img src="../img/alejandro.jpg" alt="Alejandro Perez Etchever">
                </div>
                <div class="profesionalTexto">
                    <span>Lic. en kinesiología</span>
                    <p>ALEJANDRO PEREZ ETCHEVER</p>
                </div>
            </button>
        </div>
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=constanza'">
                <div class="imgProfesional">
        ...
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=florencia'">
                <div class="imgProfesional">
        ...
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=gaston'">
                <div class="imgProfesional">
        ...
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=maria'">
                <div class="imgProfesional">
                    <img src="../img/maria.jpg" alt="Maria Paz Ruilopez">
                </div>
                <div class="profesionalTexto">
                    <span>Lic. en nutrición</span>
                    <p>MARIA PAZ RUILOPEZ</p>
                </div>
            </button>
        </div>
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=melina'">
                <div class="imgProfesional">
        ...
        <div class="profesional">
            <button onclick="location.href='detalle.php?nombre=miriam'">
                <div class="imgProfesional">
                    <img src="../img/miriam.jpg" alt="Dra. Miriam Rossello">
                </div>
                <div class="profesionalTexto">
                    <span>Especialista en miembro superior</span>
                    <p>DRA. MIRIAM ROSSELLO</p>
                </div>
            </button>
        </div>
    </section>
